...
const p_numberTemplate2 = (rowData, { rowIndex }) => <p >{rowData.accountId}</p>
...
<Column field="accountId" header="account_id" body={p_numberTemplate2} filter={selectedFilterFields.includes("accountId")} hidden={selectedHideFields?.includes("accountId")}  sortable style={{ minWidth: "8rem" }} />
