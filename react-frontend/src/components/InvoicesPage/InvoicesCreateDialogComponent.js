...
const InvoicesCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            branchId: _entity?.branchId,customerId: _entity?.customerId,invoiceDate: _entity?.invoiceDate,categoryId: _entity?.categoryId,status: _entity?.status,createdBy: _entity?.createdBy,source: _entity?.source,deliveryStatus: _entity?.deliveryStatus,description: _entity?.description,createdAt: _entity?.createdAt,updatedAt: _entity?.updatedAt,
