...
const SingleDeliveryMethodPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleDeliveryMethodId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "DeliveryMethod", type: "error", message: error.message || "Failed get deliveryMethod" });
            });
    }, [props,urlParams.singleDeliveryMethodId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Delivery Method</h3>
                </div>
                <p>deliveryMethod/{urlParams.singleDeliveryMethodId}</p>
...
export default connect(mapState, mapDispatch)(SingleDeliveryMethodPage);
