...
const SingleQrMastersPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("qrMasters")
            .get(urlParams.singleQrMastersId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "QrMasters", type: "error", message: error.message || "Failed get qrMasters" });
            });
    }, [props,urlParams.singleQrMastersId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Qr Masters</h3>
                </div>
                <p>qrMasters/{urlParams.singleQrMastersId}</p>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">qr_path</label><p className="m-0 ml-3" >{_entity?.qrPath}</p></div>
...
export default connect(mapState, mapDispatch)(SingleQrMastersPage);
