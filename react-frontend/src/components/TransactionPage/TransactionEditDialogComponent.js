...
updatedAt: _entity?.updatedAt,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info transaction updated successfully" });
    ...
    return (
        <Dialog header="Edit Transaction" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="transaction-edit-dialog-component">
...
<div className="col-12 md:col-6 field mt-5">
        <span className="align-items-center">
            ...
            <InputNumber id="debit" className="w-full mb-3 p-inputtext-sm" value={_entity?.debit} onChange={(e) => setValByKey("debit", e.value)}  />
        </span>
        </div>
<div className="col-12 md:col-6 field mt-5">
        <span className="align-items-center">
            <label htmlFor="credit">credit:</label>
            <InputText id="credit" className="w-full mb-3 p-inputtext-sm" value={_entity?.credit} onChange={(e) => setValByKey("credit", e.target.value)}  />
        </span>
        </div>
<div className="col-12 md:col-6 field mt-5">
        <span className="align-items-center">
...
export default connect(mapState, mapDispatch)(TransactionCreateDialogComponent);
