...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">unit_id</label><p className="m-0 ml-3" >{Number(_entity?.unitId)}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">stock_quantity</label><p className="m-0 ml-3" >{Number(_entity?.stockQuantity)}</p></div>
