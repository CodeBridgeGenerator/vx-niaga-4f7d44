...
projectProgress: _entity?.projectProgress,
...
updatedAt: _entity?.updatedAt,
        ...
        const result = await client.service("project").patch(_entity._id, _data);
        props.onHide();
    ...
    return (
        <Dialog header="Edit Project" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
