...
const SinglePurchaseTypePage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singlePurchaseTypeId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singlePurchaseTypeId]);


    const goBack = () => {
        navigate("/purchaseType");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Purchase Type</h3>
                </div>
                <p>purchaseType/{urlParams.singlePurchaseTypeId}</p>
...
export default connect(mapState, mapDispatch)(SinglePurchaseTypePage);
