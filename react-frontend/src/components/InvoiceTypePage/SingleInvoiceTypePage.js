...
const SingleInvoiceTypePage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("invoiceType")
            .get(urlParams.singleInvoiceTypeId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "InvoiceType", type: "error", message: error.message || "Failed get invoiceType" });
            });
    }, [props,urlParams.singleInvoiceTypeId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Invoice Type</h3>
                </div>
                <p>invoiceType/{urlParams.singleInvoiceTypeId}</p>
...
export default connect(mapState, mapDispatch)(SingleInvoiceTypePage);
