...
const SingleCategoriesPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("categories")
            .get(urlParams.singleCategoriesId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleCategoriesId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                ...
                <p>categories/{urlParams.singleCategoriesId}</p>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">type</label><p className="m-0 ml-3" >{Number(_entity?.type)}</p></div>
...
export default connect(mapState, mapDispatch)(SingleCategoriesPage);
