...
const SinglePosListsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("posLists")
            .get(urlParams.singlePosListsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "PosLists", type: "error", message: error.message || "Failed get posLists" });
            });
    }, [props,urlParams.singlePosListsId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Pos Lists</h3>
                </div>
                <p>posLists/{urlParams.singlePosListsId}</p>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">user_ids</label><p className="m-0 ml-3" >{_entity?.userIds}</p></div>
...
export default connect(mapState, mapDispatch)(SinglePosListsPage);
