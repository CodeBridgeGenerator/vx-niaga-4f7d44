...
const SingleUnitPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("unit")
            .get(urlParams.singleUnitId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                ...
                <p>unit/{urlParams.singleUnitId}</p>
...
export default connect(mapState, mapDispatch)(SingleUnitPage);
