...
const SingleCustomerTypesPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleCustomerTypesId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleCustomerTypesId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Customer Types</h3>
                </div>
                <p>customerTypes/{urlParams.singleCustomerTypesId}</p>
...
export default connect(mapState, mapDispatch)(SingleCustomerTypesPage);
