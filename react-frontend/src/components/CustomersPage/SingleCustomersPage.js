...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">customer_type</label><p className="m-0 ml-3" >{Number(_entity?.customerType)}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">ic_no</label><p className="m-0 ml-3" >{Number(_entity?.icNo)}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">dob</label><p className="m-0 ml-3" >{Number(_entity?.dob)}</p></div>
