...
const SingleDeliveryDetailPage = (props) => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">delivery_id</label><p className="m-0 ml-3" >{Number(_entity?.deliveryId)}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">delivered_qty</label><p className="m-0 ml-3" >{Number(_entity?.deliveredQty)}</p></div>
